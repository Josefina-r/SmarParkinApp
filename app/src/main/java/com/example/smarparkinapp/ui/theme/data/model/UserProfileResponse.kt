...
data class UserProfileResponse(
    ...
    // Función para convertir a UserProfile
    fun toUserProfile(): UserProfile {
        Log.d("UserProfileResponse", "Convirtiendo a UserProfile:")
        Log.d("UserProfileResponse", "  - Telefono recibido: '$telefono'")
        Log.d("UserProfileResponse", "  - Direccion recibida: '$direccion'")
        Log.d("UserProfileResponse", "  - Tipo documento: '$tipoDocumento'")
        Log.d("UserProfileResponse", "  - Numero documento: '$numeroDocumento'")
